# VIDEO 02 - Cambiar promesas por async await

En este vídeo hemos cambiado las promesas de nuestro código por sentencias async / await que permiten que leamos nuestro código mucho mejor.

Finalmente nuestro fichero car.seed.js ha quedado así:
